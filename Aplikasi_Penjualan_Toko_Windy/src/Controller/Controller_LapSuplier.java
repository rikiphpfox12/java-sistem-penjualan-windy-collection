 ...
 */
public class Controller_LapSuplier {
   
    public void cetak_preview(){
      try{
          Connection conn = Koneksi.DataBase.KoneksiDB();
          String path = "src/Report/RepLapSuplier.jasper";                                
    ...
    public void cetak_excel(){
        try{
            Connection conn = Koneksi.DataBase.KoneksiDB();
            String path = "src/Report/RepLapSuplier.jasper";  
            File xlsx = new File("D:/LapSuplier.xlsx");             
            ...
            JOptionPane.showMessageDialog(null,"Cek file pada drive D:/LapSuplier.xlsx");
